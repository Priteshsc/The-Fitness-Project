    ...
    <form name="adform" action="#" method="POST" enctype="multipart/form-data">
        <div class="row">
            ...
            <center><p class="pt-2"><b></b></p>
                ...
                <center><button onclick="exportTableToExcel('tblData')" type="button" class="btn btn-info">Export Your Excel Data</button>
                </center>


        <br><br><br>
        <center> <b>&copy;2021 All Rights Reserved. Design by&#128151Pritesh Chaudhari</b></center>
</body>
</html>
